    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#grid').datagrid({
                ...
                pagination: true,
                toolbar: toolbar,
                url: "${pageContext.request.contextPath}/region_pagingAndQuery.action",
                idField: 'id',
                columns: columns,
            ...
            $('#save').click(function(){
                $('#regionForm').form('submit',{
                    url:"${pageContext.request.contextPath}/region_save.action",
                    success:function(data){
                        ...
                        // 重置form
                        $('#regionForm').form('reset');
                        // 对form 添加离焦事件
                        $('#regionForm *').trigger('blur');
