...
<body>
	...
	<div class="main-inner" id="mainCnt"
		...
		<div id="loginBlock" class="login"
			...
			<div class="loginForm">
				<s:form action="login" id="loginform" name="loginform" method="post" theme="simple" cssClass="niceform" target="_top">
					<s:fielderror cssStyle="color: red"/>
					<s:actionerror cssStyle="color:red"/>
					<div id="idInputLine" class="loginFormIpt showPlaceholder"
						style="margin-top: 5px;">
						<s:textfield id="loginform:idInput" name="username" cssClass="loginFormTdIpt" maxlength="50" tabindex="1" title="请输入帐号"/>
						<label for="idInput" class="placeholder" id="idPlaceholder">帐号：</label>
					</div>
					<div class="forgetPwdLine"></div>
					<div id="pwdInputLine" class="loginFormIpt showPlaceholder">
						<s:password id="loginform:pwdInput" cssClass="loginFormTdIpt" name="password" tabindex="2" title="请输入密码"/>
